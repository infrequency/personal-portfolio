  ...
  return (
    <div className='w-full px-[12%] py-10 scroll-mt-20' id="work">
         <h4 className='text-center mb-2 text-lg font-ovo'>My Portfolio</h4>
          ...
          <p className='text-center font-ovo max-w-2xl mx-auto mt-5 mb-12'>  I am a store owner and fullstack webdeveloper from Jakarta, Indonesia with 4 years experience in my own company.</p> 
          <div className='grid grid-cols-(--my-grid-auto) gap-4 my-10 dark:text-black'>
              
                        {workData.map((project, index) => (
                            <div key={index}
                                style={{ backgroundImage: `url(${project.bgImage})` }}
                                className='aspect-square bg-no-repeat bg-cover bg-center rounded-lg relative cursor-pointer group'>
                                <div className='absolute bg-white w-10/12 rounded-md bottom-5 left-1/2 
