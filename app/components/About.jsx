      ...
      <motion.div
          ...
          <motion.div
              ...
              <motion.div
                  ...
                  <Image src={assets.my_profile} alt="user" className="w-full rounded-3xl" />
              </motion.div>
              <motion.div
                    initial={{opacity: 0}}
                    whileInView={{ opacity: 1}}
                  ...
                  className='flex-1'>
                  <p className='mb-10 max-w-2xl font-ovo'>Professional website developer is my current job with over 4 years in the field and many sidejobs, such as freelancer and community development. And also, i'm a business IT system analyst.
